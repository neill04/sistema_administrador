...
<div class="container d-flex flex-wrap justify-content-center gap-3">
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-desarrollo">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3 ">
        <div class="icon-section-contabilidad">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-construccion">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-electricidad">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-electronica">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-mecatronica">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-mecanica">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-produccion">
    ...
    <div class="custom-card d-flex align-items-center shadow-sm mb-3">
        <div class="icon-section-secretariado">
